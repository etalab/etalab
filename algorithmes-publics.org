...
Le tableau est généré à partir d'une autre source, merci de ne pas l'éditer directement.  Si vous voulez apporter une modification, indiquez là en [[https://github.com/etalab/etalab/issues/new][ouvrant une issue]] et sollicitez =@bzg= pour la revue.
